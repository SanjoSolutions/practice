...
function printState() {
  console.log(
    `${retrieveCellFormatted(1, 1)}|${retrieveCellFormatted(
      1,
      2
    )}|${retrieveCellFormatted(1, 3)}`
  )
  console.log(
    `${retrieveCellFormatted(2, 1)}|${retrieveCellFormatted(
      2,
      2
    )}|${retrieveCellFormatted(2, 3)}`
  )
  console.log(
    `${retrieveCellFormatted(3, 1)}|${retrieveCellFormatted(
      3,
      2
    )}|${retrieveCellFormatted(3, 3)}`
  )
  console.log('')
}
...
function findInVerticals() {
  return (
    findInVerticalFromTopLeftToBottomRight() ||
    findInVerticalFromTopRightToBottomLeft()
  )
}
